...
Source0  : https://files.pythonhosted.org/packages/84/9e/3dfd91f786df6fdfe9938a201695793484782ea412234b24392b232e500c/azure-mgmt-signalr-0.4.0.zip
...
%prep
%setup -q -n azure-mgmt-signalr-0.4.0
cd %{_builddir}/azure-mgmt-signalr-0.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047900
